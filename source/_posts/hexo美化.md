...
### 常见问题
live2d模型报错：Uncaught TypeError: Cannot read properties of undefined (reading '0')
原因在于有些模型未支持点击事件，点击模型的时候就会报此错误，可以忽视
...
### 二、增加`字数统计`，`阅读时长`的代码片段：
https://github.com/willin/hexo-wordcount 找到对应模板的使用方法，本例中使用的模板是jade（现改名为pug）
```pug
mixin word_count
  span.post-meta-group
    span.with-love 
      i.fa.fa-keyboard-o
    span.post-meta-item-text   文章字数: 
...
mixin min2read
  span.post-meta-group
    ...
    span.post-meta-item-text min
```

### 三、效果演示
![](/images/Pasted%20image%2020220515193208.png)

参考文章：
- https://moguangpeng998.github.io/2020/06/05/Hexo博客优化-添加字数统计和阅读时长/
- https://hexo.io/plugins/ 搜索wordcount
- https://github.com/willin/hexo-wordcount
- https://html2jade.org/ html转jade
- https://jade-lang.com/reference/inheritance 查询jade手册
- https://pugjs.org/api/getting-started.html pug手册
- https://github.com/hexojs/hexo-renderer-jade jade已废弃
